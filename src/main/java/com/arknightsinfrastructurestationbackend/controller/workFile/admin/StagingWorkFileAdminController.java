...
import com.arknightsinfrastructurestationbackend.service.workFile.admin.StagingWorkFileAdminService;
...
public class StagingWorkFileAdminController {
     ...
     */
    @PostMapping("/delete")
    public ResponseEntity<Object> deleteStagingWorkFile(@RequestBody WorkFileId workFileId) {
        ...
        List<StagingWorkFile> stagingWorkFileList = stagingWorkFileAdminService.screenStagingWorkFileList(null);
        return ResponseEntity.ok(new OperateAndStagingWorkFileListResult(result, FileConverter.B2FSWL(stagingWorkFileList)
                , stagingWorkFileAdminService.getStagingWorkFileListCount(null)));
    }
