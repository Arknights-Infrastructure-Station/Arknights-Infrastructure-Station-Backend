...
import com.arknightsinfrastructurestationbackend.service.workFile.admin.RecyclingWorkFileAdminService;
...
public class RecyclingWorkFileAdminController {
    ...
    public ResponseEntity<Object> recoverWorkFileFromRecyclingWorkFile(@RequestBody WorkFileId workFileId) {
        ...
        List<RecyclingWorkFile> recyclingWorkFiles = recyclingWorkFileAdminService.screenRecyclingWorkFileList(null);
        return ResponseEntity.ok(new OperateResultAndRecyclingWorkFileResult
                (result, FileConverter.B2FRWL(recyclingWorkFiles), recyclingWorkFileAdminService.getRecyclingWorkFileListCount(null)));
    }
    ...
    public ResponseEntity<Object> manuallyDeleteRecyclingWorkFile(@RequestBody WorkFileId workFileId) {
