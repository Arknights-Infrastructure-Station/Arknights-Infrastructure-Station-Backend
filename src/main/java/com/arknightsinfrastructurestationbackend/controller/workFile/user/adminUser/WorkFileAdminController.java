...
import com.arknightsinfrastructurestationbackend.service.workFile.user.adminUser.WorkFileAdminService;
...
public class WorkFileAdminController {
     ...
     */
    @PostMapping("/delete")
    public ResponseEntity<Object> deleteWorkFile(@RequestBody WorkFileAdminScreen workFileAdminScreen) {
        OperateResult result;
        try {
