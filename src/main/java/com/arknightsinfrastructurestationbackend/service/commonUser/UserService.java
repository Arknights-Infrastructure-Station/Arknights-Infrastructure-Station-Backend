package com.arknightsinfrastructurestationbackend.service.commonUser;
...
import com.arknightsinfrastructurestationbackend.mapper.commonUser.UserMapper;
...
public class UserService {
    ...
    public OperateResult login(UserLRFData userLRFData, String oldToken) {
        ...
        if (user != null && passwordEncoder.matches(userLRFData.getPassword(), user.getPassword())) {
            // 密码匹配，生成新的Token
            String newToken = jwtUtil.generateUniqueCommonUserToken(user.getId());
